"""Tests for the Johnson & Johnson ACTIS implant module."""
...
class JohnsonImplantsActisTests(unittest.TestCase):
	"""Unit tests that mirror the Johnson & Johnson ACTIS C++ table semantics."""
